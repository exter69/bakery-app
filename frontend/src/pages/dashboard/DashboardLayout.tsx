...
export default function DashboardLayout() {
  ...
  const NAV_ITEMS: { to: string; label: string; icon: React.ReactNode; end: boolean; badge?: number }[] = [
    ...
    { to: '/dashboard/stats', label: 'Statistiques', icon: <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="18" y1="20" x2="18" y2="10"/><line x1="12" y1="20" x2="12" y2="4"/><line x1="6" y1="20" x2="6" y2="14"/></svg>, end: false },
